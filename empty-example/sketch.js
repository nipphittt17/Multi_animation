...
function draw() {
    ...
    if (
        ...
        // reference for Time: https://youtu.be/klSOBa_WDB0
...
class Button {
    ...
    //reference for button: https://www.youtube.com/watch?v=YLIJLWZ-QB8&t=2s
}

function backgroundMusic() {
    // reference: https://youtu.be/uHNgkQsHLXQ
    soundGame.play();
...
function preload() {
    // reference for sound game: https://youtu.be/_9bB7r0M9kg
    soundGame = loadSound(
        "data/sound/Sound_game_super_mario_bros_soundtrack.mp3"
    );
    // reference for sound eat: https://youtu.be/6CbsgSeqP_g
